...
<body>
    ...
    <div class=" w-full  max-w-xl bg-white rounded-lg shadow-lg p-8 mx-auto mt-12">
        ...
        <form class="space-y-6 p-8 rounded-lg shadow-lg" method="POST">
            ...
            <button type="submit" class="w-full py-3 mt-4 bg-pink-900 text-white font-semibold rounded-md hover:bg-pink-700 focus:outline-none focus:ring-2  focus:ring-orange-400" aria-label="Ajouter article">Ajouter l'article</button>
        </form>
            ...
            <?php foreach ($articles as $article): ?>
                ...
                <li class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-200">
                    ...
                    <form method="POST" class="mt-4 flex space-x-4">
                        ...
                        <button type="submit" class="px-4 py-2 bg-red-600 text-white font-semibold rounded-md hover:bg-red-700 focus:outline-none focus:ring-2" aria-label="Supprimer l'article">Supprimer l'article</button>
                    </form>
                    ...
                    <form method="POST" class="mt-4 flex space-x-4">
                        ...
                        <button type="submit" class="px-4 py-2 bg-orange-300 text-white font-semibold rounded-md hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-700" aria-label="Modifier l'article">Modifier l'article </button>
                    </form>
                </li>
